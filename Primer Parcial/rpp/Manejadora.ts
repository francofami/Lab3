...
namespace PrimerParcial
{
    ...
    {
        EliminarPerro(perro) : void
        {
            let perroJSON = JSON.parse(perro);

            let xhr : XMLHttpRequest = new XMLHttpRequest();

            form.append('caso', 'eliminarbd');
        ...
        let xhr : XMLHttpRequest = new XMLHttpRequest();
            ...
            xhr.onreadystatechange = () => {
                ...
                if (xhr.readyState == 4 && xhr.status == 200) {
                    ...
                    (<HTMLDivElement> document.getElementById("divTabla")).innerHTML = xhr.responseText;        
